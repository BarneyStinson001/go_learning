...
type CategoryBrandResponse struct {
	...
	Category *CategoryInfoResponse `protobuf:"bytes,3,opt,name=shop_cart,proto3" json:"shop_cart,omitempty"`
}
...
type GoodsInfoResponse struct {
	...
	Category        *CategoryBriefInfoResponse `protobuf:"bytes,21,opt,name=shop_cart,proto3" json:"shop_cart,omitempty"`
...
var file_goods_proto_depIdxs = []int32{
	...
	4,  // 4: CategoryBrandResponse.shop_cart:type_name -> CategoryInfoResponse
	...
	21, // 8: GoodsInfoResponse.shop_cart:type_name -> CategoryBriefInfoResponse
