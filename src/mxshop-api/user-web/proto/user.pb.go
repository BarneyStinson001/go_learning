...
func (x *PasswordCheck) GetEncrypted() string {
	if x != nil {
		return x.Encrypted
	}
	return ""
...
type PageInfo struct {
	...
	PageNo   uint32 `protobuf:"varint,1,opt,name=pageNo,proto3" json:"pageNo,omitempty"`     //第几页
	PageSize uint32 `protobuf:"varint,2,opt,name=pageSize,proto3" json:"pageSize,omitempty"` //每页几个
}
...
type MobileRequest struct {
	...
	Mobile string `protobuf:"bytes,1,opt,name=mobile,proto3" json:"mobile,omitempty"` //电话
}
...
type CreateUserInfo struct {
	...
	NickName string `protobuf:"bytes,1,opt,name=nickName,proto3" json:"nickName,omitempty"` //用户名
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` //密码
	Mobile   string `protobuf:"bytes,3,opt,name=mobile,proto3" json:"mobile,omitempty"`     //手机
}
...
type UserListResponse struct {
	...
	Total int32               `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"` //共多少个用户
...
var file_user_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x27, 0x0a, 0x0d, 0x4d, 0x6f, 0x62, 0x69, 0x6c,
	...
	0x74, 0x79, 0x12, 0x37, 0x0a, 0x0d, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x77,
	0x6f, 0x72, 0x64, 0x12, 0x0e, 0x2e, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x43, 0x68,
	0x65, 0x63, 0x6b, 0x1a, 0x16, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x77,
	0x6f, 0x72, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e,
...
var file_user_proto_goTypes = []interface{}{
	(*PasswordCheck)(nil),         // 0: PasswordCheck
...
var file_user_proto_depIdxs = []int32{
	...
	0, // 6: User.CheckPassword:input_type -> PasswordCheck
...
type UserClient interface {
	...
	CheckPassword(ctx context.Context, in *PasswordCheck, opts ...grpc.CallOption) (*CheckPasswordResponse, error)
}
...
func (c *userClient) CheckPassword(ctx context.Context, in *PasswordCheck, opts ...grpc.CallOption) (*CheckPasswordResponse, error) {
...
type UserServer interface {
	...
	CheckPassword(context.Context, *PasswordCheck) (*CheckPasswordResponse, error)
}
...
func (*UnimplementedUserServer) CheckPassword(context.Context, *PasswordCheck) (*CheckPasswordResponse, error) {
